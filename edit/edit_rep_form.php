...
} else if ($_SESSION['previous_page'] != 'vendors_mgt.php' and $_SESSION['previous_page'] != 'edit_rep_form.php') {
	header('Location: ../index.php');
} else {

$page = 'vendor';

$_SESSION['previous_page'] = 'edit_rep_form.php';
...
if (isset($_POST['edit_rep_input']))
{
	...
	{
		if ($row['rep_id'] == $_POST['edit_rep_input'])
		{
			$found = true;
	...
	<div id="content" class="pull-left">
		<form name="edit_rep_form" action="edit_rep_submit.php" method="post" class="edit_form" onsubmit="return editRepVal();">
			<table class="table-mgt">
				<thead>
					<tr>
						<th colspan="2"><h1>Edit Vendor Rep</h1></th>
					</tr>
				</thead>
				<tbody>
					<tr>
						...
						<td>
							<input type="text" name="rep_fn" id="rep_fn" size="45" class="form-control" value="'. $row['rep_fn'] .'" />
						</td>
					</tr>
					<tr>
						<td>
						...
						<td>
							<input type="text" name="rep_ln" id="rep_ln" size="45" class="form-control" value="'. $row['rep_ln'] .'" />
						</td>
					</tr>';	
			...
			while ($row2 = mysqli_fetch_array($results2))
			{
				...
				$sql3 = "select rep_contact from VendorContact where VendorContact.rep_id = ". $row['rep_id'] ." and VendorContact.rep_cid = ". $row2['rep_cid'] .";";
				...
				if (mysqli_num_rows($results3) == 0)
				{
					...
					while ($row3 = mysqli_fetch_array($results3))
					{
						echo "
							<td>
								<input type='text' name='rep_cid_". $row2['rep_cid'] ."' id='rep_cid_". $row2['rep_cid'] ."' size='45' value='". $row3['rep_contact'] ."' class='form-control' />
							</td>";
					}
				}
	...
	if ($found == false)
	{
		...
		<!-- Content Start -->
		<div id="content" class="pull-left">
			<h1>Edit Vendor Rep</h1>
			<p>The vendor rep was not found.</p>
...
else
{
	...
	<div id="content" class="pull-left">
		<h1>Edit Vendor Rep</h1>
		<p>There was an issue editing the vendor rep.</p>
		<a class="btn btn-default" href="../php/vendors_mgt.php">Return</a>
	</div>
	<!-- Content End -->';
}
